      ...
      : super(
          ...
          onClick: (context, _) {
            ...
            Share.share(currentLocale == "en"
                ? """
            Download the "Not Without My Bike" app, the public transport app for Hamburg and its surroundings on https://tinyurl.com/NWMBRecEn
            """
                : """
            Hol' dir die "Nicht ohne mein Rad" App für den öffentlichen Nahverkehr in Hamburg und Umgebung auf https://tinyurl.com/NWMBRecDe
            """);
          },
        );
}
